...
for _ in pd.date_range('2023-04-01', '2023-10-31', freq='D'):
    ...
    os.system('python -u run.py --task_name long_term_forecast --is_training 1 --root_path ./data/ --data_path shanxi_elec.csv --model_id shanxi_{} --model FEDformer --data shanxi --features MS --seq_len 672 --label_len 96 --pred_len 96 --inverse  --e_layers 2 --d_layers 1 --factor 3 --enc_in 11 --dec_in 11 --c_out 1 --des Exp --itr 1 --top_k 5 --tgt_dt {}'.format(_.strftime('%Y-%m-%d'), _.strftime('%Y-%m-%d')))# --d_model 128 --d_ff 128
...
#     print(_.strftime('%Y-%m-%d'))
#     os.system('python -u run.py --task_name long_term_forecast --is_training 1 --root_path ./data/ --data_path iso_new_england.csv --model_id iso_{} --model iTransformer --data iso_new_england --features MS --seq_len 168 --label_len 24 --pred_len 24 --inverse  --e_layers 2 --d_layers 1 --factor 3 --enc_in 9 --dec_in 9 --c_out 1 --d_model 128 --d_ff 128 --des Exp --itr 1 --top_k 5 --tgt_dt {}'.format(_.strftime('%Y-%m-%d'), _.strftime('%Y-%m-%d')))
